import { Moon, Sun, Menu, X, Gift, GraduationCap } from 'lucide-react';
// import Link from 'next/link'; // Import Link for navigation - This caused the error
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">
          <div className="px-4 py-3 space-y-3">
            ...
            {/* Animated Formation Button for Mobile */}
            <a
              href="/formation"
